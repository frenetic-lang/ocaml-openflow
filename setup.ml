...
(* OASIS_START *)
(* DO NOT EDIT (digest: 27baacebdede1e86ec285ee7b23a7fb3) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "Learning_Switch0x04.ml"
                   })
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "d%\205\146\031b\183\007\225\199\199\227`EcG";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
