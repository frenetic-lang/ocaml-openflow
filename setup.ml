...
(* OASIS_START *)
(* DO NOT EDIT (digest: 33d5d7a3c5f460335f8e5243a24e5f0b) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$testtool", ["inline-test-runner"; "openflow"]))
                   ];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the openflow.async library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["OpenFlow_Arbitrary"; "OpenFlow0x01_Arbitrary"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Hypervisor.ml"});
               Executable
                 ({
                     cs_name = "learning_switch";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "Learning_Switch.ml"});
               Executable
                 ({
                     cs_name = "leak_exercise";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "LeakExercise.ml"})
            ];
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\178a\179\164\211i\195\212\153\160\248\1457\r\221\246";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
